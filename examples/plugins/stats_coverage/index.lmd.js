...
sb.on('stats:before-return-stats', function (moduleName, stats_results) {
    ...
    $(function() {
        require.coverage_function("main", "(?):11:231");
        ...
        function calculateSha512OfMd5() {
            require.coverage_function("main", "calculateSha512OfMd5:16:350");
