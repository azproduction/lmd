...
Module.prototype.resolveModuleType = function () {
    ...
    try {
        ...
        if (reModuleIsJavaScript.test(this.fileName)) {
            this.addWarning(
 ...
 * @returns {Boolean}
 */
Module.prototype._isPlainModule = function (ast) {
 ...
 * @returns {Boolean}
 */
Module.prototype._isFdModule = function (ast) {
 ...
 * @returns {Boolean}
 */
Module.prototype._isFeModule = function (ast) {
    return ast && ast.length === 2 &&
           ast[1] && ast[1].length === 1 &&
           ast[1][0][0] === 'stat' &&
           ast[1][0][1] &&
 ...
 * @returns {Boolean}
 */
Module.prototype._isAmdModule = function (ast) {
