...
var MASTER_FIELDS = ['version', 'main', 'global', 'lazy', 'pack', 'pack_options', 'log', 'warn', 'mixins', 'plugins',
                     'output', 'path', 'root', "sourcemap", "sourcemap_inline", "sourcemap_www", "www_root"];

var INHERITABLE_FIELDS = ['version', 'main', 'global', 'lazy', 'pack', 'pack_options', 'log', 'warn', 'mixins', 'plugins'];
...
var collectFlagsWarnings = function (config, deepModulesInfo) {
    ...
    var warnings = {
        globals: 'Some of your modules are undeclared (you can register them as ' + '"name"'.green + ': ' + '"@shortcut"'.green + '):',
