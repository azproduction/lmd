...
var findRequireCalls = function (ast) {
...
var findModuleRequirements = function (requireExpressions) {
...
var analiseModuleContent = function (moduleOptions) {
    ...
    var requireExpressions = findRequireCalls(ast);

    moduleDescriptor.features = findModuleRequireFeatures(requireExpressions);
    moduleDescriptor.requires = findModuleRequirements(requireExpressions);
