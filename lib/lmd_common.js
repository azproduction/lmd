...
var MASTER_FIELDS = ['version', 'main', 'global', 'lazy', 'pack', 'pack_options', 'log', 'warn', 'output', 'path', 'root', "sourcemap", "sourcemap_inline", "sourcemap_www", "sourcemap_root"];
var INHERITABLE_FIELDS = ['version', 'main', 'global', 'lazy', 'pack', 'pack_options', 'log', 'warn'];
